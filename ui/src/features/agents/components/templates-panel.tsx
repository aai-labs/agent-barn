  ...
  return (
    <>
      <div className="af-card p-5">
        ...
        {error && (
          <div className="py-8 text-center text-[0.8rem]" style={{ color: "var(--err)" }}>
        ...
        {templates.map((t) => (
          ...
          >
            <div className="flex-1">
              <div className="font-medium text-[0.875rem] flex items-center gap-2" style={{ color: "var(--ink)" }}>
                <span>{t.templateName}</span>
                <span className="font-mono text-[0.75rem] font-normal" style={{ color: "var(--ink-4)" }}>
                  · v{t.version}
                </span>
                <TemplateSourceBadge
