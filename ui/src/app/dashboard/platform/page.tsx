...
const platformLinks = [
  {
    ...
    title: "Users",
    description: "Manage platform accounts, password resets, and account removal.",
    Icon: UsersIcon,
  },
  {
    href: "/dashboard/platform/organizations",
    title: "Organizations",
    description: "Manage customer organizations and jump into organization view.",
    Icon: BuildingIcon,
  },
];
      ...
      <div className="max-w-[980px] mx-auto px-10 pt-9 pb-24">
        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
          {platformLinks.map(({ href, title, description, Icon }) => (
            <Link key={href} href={href} className="af-card af-card-hover block px-5 py-[18px]">
              ...
              <p className="text-[13.5px] leading-[1.45]" style={{ color: "var(--ink-3)" }}>
                {description}
              </p>
            </Link>
          ))}
