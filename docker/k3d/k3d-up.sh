...
printf "  ./run.sh sets API_K8S_KUBECONFIG_PATH in .env automatically.\n\n"
...
printf "    ./run.sh      → api container serves ingest automatically (port published)\n"
printf "    make dev-api  → starts ingest alongside the native dev API automatically\n\n"
