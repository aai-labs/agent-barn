...
# Hermes' application data and Agent Barn's persistent workspace are both
# intentional write locations. Preserve any deployment-specific roots while
# ensuring the two runtime mounts are always in the allowlist.
