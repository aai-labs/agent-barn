...
from api.domains.events.catalog import (
    ...
    ORGANIZATION_AGENT_SETTINGS_CHANGED,
...
class SecurityAuditProjection:
    ...
    supported_events: ClassVar[Sequence[SupportedEvent]] = (
        ...
        SupportedEvent(AGENT_RESTORE_POINT_RESTORED, 1),
        ...
        SupportedEvent(ORGANIZATION_AGENT_SETTINGS_CHANGED, 1),
        SupportedEvent(ORGANIZATION_LLM_BUDGET_CHANGED, 1),
        SupportedEvent(AGENT_LLM_BUDGET_CHANGED, 1),
        ...
        SupportedEvent(COMMUNICATION_CONNECTION_HEALTH_CHANGED, 1),
        SupportedEvent(COMMUNICATION_CONNECTION_RECONNECT_REQUESTED, 1),
        SupportedEvent(COMMUNICATION_DELIVERY_DEAD_LETTERED, 1),
        SupportedEvent(COMMUNICATION_DELIVERY_RETRY_REQUESTED, 1),
        SupportedEvent(COMMUNICATION_DELIVERY_RECOVERED, 1),
    )
