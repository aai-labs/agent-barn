...
def upgrade() -> None:
    ...
    op.alter_column(
        "agent", "template_slug", existing_type=sa.String(length=255), nullable=True
    )
    op.alter_column(
        "agent", "template_version", existing_type=sa.Integer(), nullable=True
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "agent", "template_version", existing_type=sa.Integer(), nullable=False
    )
    op.alter_column(
        "agent", "template_slug", existing_type=sa.String(length=255), nullable=False
    )
