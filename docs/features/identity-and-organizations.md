...
Both creation paths provision an Organization-scoped LiteLLM team after commit when the proxy is configured. Team identity, reconciliation, and optional deployment budgets are owned by [Costs](costs.md#organization-llm-budgets).
