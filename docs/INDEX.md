...
| AF-280 Honcho Memory Layer delivery state                            | [`features/af-280-honcho-memory-layer/CHANGELOG.md`](features/af-280-honcho-memory-layer/CHANGELOG.md) | Agent memory backend, per-Agent workspaces, memory cost attribution, and workspace lifecycle |
