...
| Templates, template versions, required skills, or skill versions/files/drafts | [`features/templates-and-skills.md`](features/templates-and-skills.md) | `../api/domains/templates/`, `../api/domains/skills/`, `../ui/src/features/platform-templates/`, `../ui/src/features/skills/` |
