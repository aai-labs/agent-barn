...
| Agent Webhooks, signed machine triggers, Agent Trigger Jobs, or Webhook Invocations | [`features/agent-webhooks.md`](features/agent-webhooks.md) | `../api/domains/agent_webhooks/`, `../api/domains/agents/scripts/agent-trigger-server.py`, `../ui/src/features/agent-webhooks/` |
| Agent Webhooks decoupling delivery state | [`features/agent-webhooks/CHANGELOG.md`](features/agent-webhooks/CHANGELOG.md) | Agent Webhook persistence, native job submission, Communications removal, and UI cutover slices |
| Agent Restore Points: capture, restore, retention, or the archive exclusion sets | [`features/agents.md`](features/agents.md) | `../api/domains/restore_points/`, `../api/domains/agents/restore_point_job.py`, `../api/domains/agents/builders/restore_point.py` |
| AF-292 Agent Restore Points delivery state | [`features/agent-restore-points/CHANGELOG.md`](features/agent-restore-points/CHANGELOG.md) | [`adr/2026-09-10-restore-points-use-tar-jobs-not-csi-snapshots.md`](adr/2026-09-10-restore-points-use-tar-jobs-not-csi-snapshots.md), capture/restore, reclamation, and UI slices |
...
| AF-271 Agent update prompt delivery state                           | [`features/af-271-agent-update-prompt/CHANGELOG.md`](features/af-271-agent-update-prompt/CHANGELOG.md) | `../api/domains/agents/runtime_digest.py`, the runtime configuration digest, `update_available`, and the Agent page Update control |
...
| Templates, template versions, required skills, or skill versions/files/drafts | [`features/templates-and-skills.md`](features/templates-and-skills.md) | `../api/domains/templates/`, `../api/domains/skills/`, `../ui/src/features/templates/`, `../ui/src/features/skills/` |
| AF-282 Organization Template draft/publish delivery state           | [`features/org-template-drafts/CHANGELOG.md`](features/org-template-drafts/CHANGELOG.md) | [`adr/2026-09-04-organization-templates-use-draft-publish.md`](adr/2026-09-04-organization-templates-use-draft-publish.md), Organization Template draft, publish, Template Update, and version-history slices |
...
| Agent Activity wakes, prompt-size distributions, and runtime investigation | [`features/agent-activity.md`](features/agent-activity.md) | `../api/domains/activity/`, `../ui/src/features/agents/components/activity-tab.tsx` |
...
| Cost records, the cost sync/healing CronJob, spend attribution, Organization LLM budgets, monthly aggregates, the Costs pages, or an Agent's Costs tab | [`features/costs.md`](features/costs.md)                                           | `../api/domains/costs/`, `../api/domains/organizations/service.py`, `../ui/src/features/costs/`, `../helm/agentbarn-api/templates/cost-sync-cronjob.yaml`, `../docs/plans/AF-281-cost-tracking-findings.md` |
...
| Communication Connections, Platform Plugins, or gateway delivery    | [`features/communications/CHANGELOG.md`](features/communications/CHANGELOG.md)     | `../api/communications_app.py`, `../api/domains/communications/`, runtime adapters, `../ui/src/features/communication-connections/` |
| Active AF-276 email communication platform delivery state           | [`features/email-communications/CHANGELOG.md`](features/email-communications/CHANGELOG.md) | Email infrastructure, agent address allocation, the Email Platform Plugin, and inbound gateway slices |
| Active AF-325 interactive command approval delivery state           | [`features/interactive-approvals/CHANGELOG.md`](features/interactive-approvals/CHANGELOG.md) | `../api/domains/communications/plugins/approvals.py`, approval-capable Platform Plugins, the runtime adapter, Web Chat, and per-platform slices |
