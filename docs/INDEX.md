...
| Internal Domain Events, Outbox Messages, Event Deliveries, Event Handlers, or audit projections | [`features/domain-events.md`](features/domain-events.md) | `../api/domains/events/`, event-producing domain repositories, `../api/migrations/versions/` |
