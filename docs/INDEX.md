...
| Templates, template versions, required skills, or skill archives    | [`features/templates-and-skills.md`](features/templates-and-skills.md)             | `../api/domains/templates/`, `../api/domains/skills/`, `../ui/src/features/templates/`               |
