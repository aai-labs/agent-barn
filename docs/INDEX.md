...
| RBAC, permissions, or assigned Agent access                         | [`features/rbac/IMPLEMENTATION-BRIEF.md`](features/rbac/IMPLEMENTATION-BRIEF.md)   | RBAC ADRs, identity/Agent features, authorization and Agent repositories                                    |
