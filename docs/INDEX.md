...
| AF-280 Honcho Memory Layer delivery state                            | [`features/af-280-honcho-memory-layer/CHANGELOG.md`](features/af-280-honcho-memory-layer/CHANGELOG.md) | Agent memory backend, shared memory pools via groups, per-group memory cost, and workspace lifecycle |
