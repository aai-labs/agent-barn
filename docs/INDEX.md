...
| AF-341 required Skill Version delivery state | [`features/af-341-required-skill-versions/CHANGELOG.md`](features/af-341-required-skill-versions/CHANGELOG.md) | [`features/templates-and-skills.md`](features/templates-and-skills.md), required-skill version enforcement in `../api/domains/agents/selection.py`, and the Agent configuration Template and Skills sections |
